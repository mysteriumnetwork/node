...
func subscribeSessionCreate(mng *session.SessionManager, ch p2p.Channel, service Service, eventPublisher eventbus.Publisher, proposal market.ServiceProposal, policyRules *policy.Repository) {
...
func subscribeSessionStatus(mng *session.SessionManager, ch p2p.ChannelHandler, statusStorage connectivity.StatusStorage) {
...
func subscribeSessionDestroy(mng *session.SessionManager, ch p2p.ChannelHandler, done func()) {
...
func subscribeSessionAcknowledge(mng *session.SessionManager, ch p2p.ChannelHandler) {
