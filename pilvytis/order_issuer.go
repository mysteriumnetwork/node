...
func (o *OrderIssuer) CreatePaymentGatewayOrder(id identity.Identity, gw string, mystAmount float64, payCurrency string, callerData json.RawMessage) (*PaymentOrderResponse, error) {
