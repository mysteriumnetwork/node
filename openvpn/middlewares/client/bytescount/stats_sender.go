...
func NewSessionStatsSender(mysteriumClient server.Client, sessionID session.SessionID, providerID identity.Identity, signer identity.Signer, clientCountry string) SessionStatsHandler {
