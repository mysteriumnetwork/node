...
func TestInvoiceTracker_recoverR(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			err:     errors.Wrap(errors.New("some err"), `Secret R for previous promise exchange (Encrypted recovery data: "") was not revealed: r recovery required`),
			wantErr: false,
		},
		{
