...
func NewDialogHandler(sessionManagerFactory ManagerFactory, configProvider ConfigProvider, receiverID identity.Identity, statusReceiver connectivity.StatusSubscriber) *handler {
	return &handler{
