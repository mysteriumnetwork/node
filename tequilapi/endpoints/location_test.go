...
func (fm *fakeManagerForLocation) Connect(consumerParams connection.ConsumerParams, proposal market.ServiceProposal, options connection.ConnectParams) error {
	return nil
}
